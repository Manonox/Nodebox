...
[Alias("<=")]
[Polymorphic(true)]
public class LessThanOrEqual : Node
{
	...
	public override Node Polymorph(PinWireChange change) =>
        PolymorphHelpers.ToConnectedInputTypeIfRegistered(typeof(LessThan<>), change);
}
...
[Polymorphic(typeof(LessThanOrEqual))]
public class LessThanOrEqual<T> : LessThanOrEqual
{
    ...
    public override Node Polymorph(PinWireChange change) =>
        PolymorphHelpers.ToNonGenericIfAllInputsDisconnected<LessThanOrEqual>(change);
}
