...
public class Multiply<T> : Node
{
    ...
    public override string Name => $"Multiply<{typeof(T).GetPrettyName()}>";
    ...
    public override void Evaluate() {
        ...
        if (typeof(T) == typeof(Angles)) {
            var a = GetInput<Angles>(0);
            var b = GetInput<Angles>(0);
            SetOutput(0, new Angles(a.pitch * b.pitch, a.yaw * b.yaw, a.roll * b.roll));
            return;
        }
