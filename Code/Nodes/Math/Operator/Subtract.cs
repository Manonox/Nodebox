...
public class Subtract : Node
{
	...
	public override Node Polymorph(PinWireChange change) =>
        PolymorphHelpers.ToConnectedTypeIfRegistered(typeof(Subtract<>), change);
}
...
[Polymorphic(typeof(Subtract))]
public class Subtract<T> : Subtract
{
    ...
    public override Node Polymorph(PinWireChange change) =>
        PolymorphHelpers.ToNonGenericIfAllDisconnected<Subtract>(change);
